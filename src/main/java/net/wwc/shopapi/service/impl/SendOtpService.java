...
import net.wwc.shopapi.model.Response;
...
public class SendOtpService {
   ...
   */
  /*public SendOtpService(String authKey, String messageTemplate) {
  ...
  /*public SendOtpService(String authKey) {
    this.authKey = authKey;
    this.messageTemplate = "Your otp is {{otp}}. Please do not share it with anybody";
  }*/
  ...
  public String setAuthKey(String auth) {
    return this.authKey=auth;
  }

  public String setMessageTemplate(String messageTemplate)
  {
    return this.messageTemplate=messageTemplate;
  }
  ...
  private SendOtpResponse post(final String path, final Map<String, String> params, String userAgent) {
    ...
    SendOtpResponse sendOtpResponse = new SendOtpResponse(params.get("otp"), 
      response.getMessage(), response.getType(),params.get("mobile"));
